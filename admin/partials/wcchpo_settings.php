							...
							<form method="post" action="options.php">
								...
								<table class="form-table">
									...
									<tr valign="top">
										...
										<td> <input type="color" name="wcchpo_colour_total" value="<?php echo empty(get_option('wcchpo_colour_total'))? "#cccccc" : esc_attr(get_option('wcchpo_colour_total')) ;?>" id='wcchpo_colour_total'  class="all-options" /> </td>
									</tr>
											...
											if( $key == "pending" ) {
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>" >
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#AFFD71" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/>  
														</td>
													</tr>
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#c6e1c6" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/> 
														</td>
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#f8dda7" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/>  
														</td>
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#61B329" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" class="all-options" 
															/>  
														</td>
													</tr>
													<?php
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#092366" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/>  
														</td>
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#FF2400" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/>  
														</td>
													...
													<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
														...
														<td> 
															<input 
																type="color" 
																name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#CD0000" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
																id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
																class="all-options" 
															/>  
														</td>
												...
												<tr valign="top" class="<?php echo (++$i % 2) ? "alternate" : ""; ?>">
													...
													<td> 
														<input 
															type="color" 
															name="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
															value="<?php echo empty(get_option("wcchpo_colour_".$key))? "#17202A" : esc_attr(get_option("wcchpo_colour_".$key)) ;?>" 
															id="<?php echo "wcchpo_colour_".esc_attr($key); ?>" 
															class="all-options" 
														/>  
													</td>
